...
export default function MenuGallery1() {
	return (
		<div className={styles.gallery_container}>
			<div className={styles.gallery_item}>
				...
				<p>
					Our Matcha Iced Tea is a refreshing and invigorating beverage that's perfect for a warm
					day. Made with high-quality matcha powder and freshly brewed green tea, this drink is the
					ultimate pick-me-up. The matcha powder gives it a vibrant green color and a rich, earthy
					flavor, while the green tea adds a subtle, refreshing note. Served over ice, it's a
					delicious and healthy way to stay cool and hydrated. Whether you're a matcha lover or just
					looking for a new way to enjoy iced tea, our Matcha Iced Tea is sure to hit the spot!
				</p>
			</div>
			<div className={styles.gallery_item}>
				<a href='/Menu'>
			...
			<div className={styles.gallery_item}>
				...
				<p>
					...
					balanced and smooth, it's a true coffee lover's delight. Come in and experience the bold
					taste of Vietnam with our Robusta Vietnamese coffee.
				</p>
			</div>
			<div className={styles.gallery_item}>
				<a href='/Menu'>
			...
			<div className={styles.gallery_item}>
				...
				<p>
					...
					the coffee, creating a harmonious and delicious flavor profile. If you're a fan of coconut
					or just looking for a new way to enjoy your iced coffee, give our Coconut Iced Coffee a
					try!
				</p>
			</div>
		</div>
