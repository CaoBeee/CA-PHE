    ...
    return (
        <div className={styles.container}>
            ...
            <div className={buttons.container }>
                <div>
                    <button id={buttons.all} className={buttons.menu_button} style={{ backgroundColor: Menu == 0 && selectedColor || notSelectedColor }}
                        onClick={() => {
                            setMenu(0)
                        }}>All</button>

                    <button id={buttons.coffee} className={buttons.menu_button} style={{ backgroundColor: Menu == 1 && selectedColor || notSelectedColor }}
                        onClick={() => {
                            setMenu(1)
                        }}>Coffee</button>

                    <button id={buttons.seasonal} className={buttons.menu_button} style={{ backgroundColor: Menu == 2 && selectedColor || notSelectedColor }}
                        onClick={() => {
                            setMenu(2)
                        }}>Seasonal</button>
                </div>
                <div>
                    <button id={buttons.tea} className={buttons.menu_button} style={{ backgroundColor: Menu == 3 && selectedColor || notSelectedColor }}
                        onClick={() => {
                            setMenu(3)
                        }}>Teas</button>

                    <button id={buttons.milk_tea} className={buttons.menu_button} style={{ backgroundColor: Menu == 4 && selectedColor || notSelectedColor }}
                        onClick={() => {
                            setMenu(4)
                        }}>Milk Teas</button>

                    <button id={buttons.other} className={buttons.menu_button} style={{ backgroundColor: Menu == 5 && selectedColor || notSelectedColor }}
                        onClick={() => {
                            setMenu(5)
                        }}>Other</button>
                </div>
